...
namespace SeekASoul
{
	namespace Gameplay
	{
		Bullet::Bullet(const std::shared_ptr<Engine::TextureManager>& textureManager, const sf::Vector2f& dir, const sf::Vector2f pos)
		...
		void Bullet::OnCollision(Engine::BoxCollideable* other, Engine::CollisionDirection direction)
		{
			if (!m_HadImpact) 
			{
